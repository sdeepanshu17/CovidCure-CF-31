...
def home():
    ...
    bg = ImageTk.PhotoImage(file = r"F:\Tkinter Course\Login System\PROJECT\img.png")       #BACKGROUND IMAGE
    Label(root, image=bg).place(x=0, y=0, relwidth=1, relheight=1 )

    l1 = Label(root, fg='black',bg="#adffe3", font=("Bebas Neue", 30, "bold"), text="Welcome to COVID-19 HELPLINE")     #TOP LABEL
    l1.place(x=0, y=0, height=67, width=1300)

    bgg = ImageTk.PhotoImage(file="F:\Tkinter Course\Login System\PROJECT\corona.png")  # LOGO
    #Label(root, image=bgg,borderwidth=0).place(x=30)

    root.iconphoto(False, bgg)

    bg1 = ImageTk.PhotoImage(file="F:\Tkinter Course\Login System\PROJECT\ShoeCategory\stats.jpg")      #TYPE 1 SNEAKERS
    ...
    bg2 = ImageTk.PhotoImage(file="F:\Tkinter Course\Login System\PROJECT\ShoeCategory\info.jpg")    
    ...
    bg3 = ImageTk.PhotoImage(file="F:\Tkinter Course\Login System\PROJECT\ShoeCategory\donatee.jpg")      
    ...
    bg4 = ImageTk.PhotoImage(file="F:/Tkinter Course/Login System/PROJECT/ShoeCategory/assist.jpg")      
    ...
    bg5 = ImageTk.PhotoImage(file="F:/Tkinter Course/Login System/PROJECT/ShoeCategory/corona.png")      
...
def data():
    ...
    bg5 = ImageTk.PhotoImage(file=r"F:\Tkinter Course\Login System\PROJECT\sbg8.png")  # BACKGROUND IMAGE
    Label(root2, image=bg5).place(x=0, y=0, relwidth=1, relheight=1)

    # Label(root2, fg='Cyan', font=("Azonix", 30, "bold"), text="Exclusive Sneakers Collection").place(x=0, y=0, height=67, width=1300)

    # bgg = ImageTk.PhotoImage(file="F:\Tkinter Course\Login System\CS_PROJECT\Shoezz3.png")  # LOGO IMAGE
    # Label(root2, image=bgg).place(x=240)
    l1 = Label(root2, fg='black',bg="#adffe3", font=("Bebas Neue", 30, "bold"), text="COVID-DATA")     #TOP LABEL
    l1.place(x=0, y=0, height=67, width=1300)

    bgg = ImageTk.PhotoImage(file=r"F:\Tkinter Course\Login System\PROJECT\corona.png")  
    ...
    def grab_and_assign(event):
        ...
        #la2=Label(root2, image=i2).place(x=700, y=220)
        if cases==None:
    ...
    i1=ImageTk.PhotoImage(file="F:/Tkinter Course/Login System/PROJECT/ShoeCategory/danger.png")
    i2=ImageTk.PhotoImage(file="F:/Tkinter Course/Login System/PROJECT/ShoeCategory/risky.png")
    i3=ImageTk.PhotoImage(file="F:/Tkinter Course/Login System/PROJECT/ShoeCategory/low.png")

    l2 = Label(root2, font=("Bebas Neue", 30, "bold"), text="Select a City:")     #TOP LABEL
...
def info():
    ...
    bg5 = ImageTk.PhotoImage(file=r"F:\Tkinter Course\Login System\PROJECT\sbg8.png")
    ...
    def more():
        ...
        bg6 = ImageTk.PhotoImage(file=r"F:\Tkinter Course\Login System\PROJECT\sbg8.png")
...
def donate():
    ...
    l1 = Label(root3, fg='black',bg="#adffe3", font=("Bebas Neue", 30, "bold"), text="DONATION-CENTER")     #TOP LABEL
    l1.place(x=0, y=0, height=67, width=1300)
    ...
    bg1 = ImageTk.PhotoImage(file=r"F:\Tkinter Course\Login System\PROJECT\ShoeCategory\save.png")      #TYPE 1 SNEAKERS
    ...
    bg2 = ImageTk.PhotoImage(file=r"F:\Tkinter Course\Login System\PROJECT\ShoeCategory\accept.jpg")    
